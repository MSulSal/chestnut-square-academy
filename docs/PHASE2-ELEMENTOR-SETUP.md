...
- Preflight blocks launch until domain ownership/DNS verification checkbox is confirmed in Business Profile settings.
...
- Business profile fields include example placeholders and descriptions of where each value appears.
